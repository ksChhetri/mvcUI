...
<caption><h1 style="color:#113d84;text-align:center;border-bottom:2px solid #113d84;width:450px">Registration Form </h1>
<form:form method="POST" commandName="stCmd">
</caption>
<tr><td>Student number ::</td><td><form:input path="sno" readonly="true" disabled="true"/></td></tr>
<tr><td>Student name  ::</td><td><form:input path="sname"/><form:errors cssStyle="color:red" path="sname" /></td></tr>
<tr><td>student address ::</td><td><form:input path="sadd"/><form:errors path="sadd"/></td></tr>
<tr><td>student Branch ::</td><td><form:input path="sbranch"/><form:errors path="sbranch"/></td></tr>
<tr><td>student Fee ::</td><td><form:input path="sfee"/><form:errors path="sfee"/></td></tr>
